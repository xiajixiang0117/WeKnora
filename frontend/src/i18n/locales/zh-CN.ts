export default {
  ...
  sessionManagement: {
    documentCitationNote: "该引用仅关联到文档 URL；此片段属于该来源，无法据此确定模型引用了哪个具体 chunk。",
    viewChunk: "展开 chunk 内容",
    noChunks: "没有记录 chunk",
    notSelected: "未选中",
    chunkUnavailable: "未保存该 chunk 的正文，无法还原当时内容。",
    referenceContentNote: "内容来自当次回答保存的引用，可能包含合并片段；并非原始召回正文快照。",
    viewAnswer: "查看回答",
    finalAnswer: "最终回答",
    partialAnswer: "该请求未完成，以下为已生成的部分内容。",
    fallbackAnswer: "该回答为兜底回答。",
    noAnswer: "没有已生成的回答内容。",
    answerUnavailable: "未保存回答快照，且无法从关联消息恢复。",
    citedChunks: "回答引用的 chunk",
    citedChunksNote: "仅列出回答通过引用标记明确引用的片段。进入模型上下文不代表最终被引用。",
    noCitedChunks: "未识别到明确的 chunk 引用；可能未启用引用或答案没有引用片段。",
    contextUnavailable: "本次请求未记录送入 LLM 的 chunk，无法从重排结果推断。",
    generationContext: "送入 LLM 的 chunk",
    generationContextNote: "本阶段加入模型上下文的片段（已记录 / 总数）",

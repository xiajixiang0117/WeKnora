export default {
  sessionManagement: {
    ...
    "viewAnswer": "查看回答",
    "finalAnswer": "最终回答",
    "executionTraces": "执行轨迹",
    "loadingTraces": "正在加载执行轨迹",
    "viewTrace": "查看轨迹",
    "noTraces": "暂无执行轨迹",
    "traceDetail": "轨迹详情",
    "answerUnavailable": "暂无回答记录",
    "citedChunks": "引用片段",
    "citedChunksNote": "展示该回答引用的知识库片段。",
    "truncated": "内容已截断",
    "noCitedChunks": "暂无引用片段",
    "contextUnavailable": "该轨迹未记录模型输入上下文。",
    "generationContext": "模型输入上下文",
    "rewrittenQuery": "改写查询",
    "expansionQueries": "扩展查询",
    "recalledCount": "召回数量",
    "threshold": "阈值",
    "generationContextNote": "生成回答时捕获的上下文片段",
    "allChannels": "全部渠道",
    "loadFailed": "加载会话失败，请重试",
    "loadDetailsFailed": "加载会话详情失败，请重试",
    "loadTracesFailed": "加载执行轨迹失败，请重试",
    "loadTraceFailed": "加载轨迹详情失败，请重试",
    "partialAnswer": "回答尚未完成",
    "fallbackAnswer": "此回答使用了兜底回复",
    "noAnswer": "暂无回答内容",
    "noChunks": "暂无片段",
    "selected": "已选中",
    "notSelected": "未选中",
    "viewChunk": "查看片段",
    "documentCitationNote": "此引用匹配到文档，无法确认具体片段。",
    "referenceContentNote": "正文来自回答引用，可能与检索时的内容不同。",
    "chunkUnavailable": "暂无片段正文",
    "columns": {
      "question": "问题",
      "session": "会话",
      "channel": "渠道",
  ...
  datasource: {
    ...
    scheduleEditor: {
      manual: '手动同步', minutes: '按分钟', hourly: '按小时', daily: '每天', weekly: '每周', monthly: '每月', advanced: '高级 Cron 表达式',
      interval: '每隔', minuteUnit: '分钟', hourUnit: '小时', atTime: '执行时间', atMinute: '第几分钟', monthDay: '每月几号',
      weekday0: '周日', weekday1: '周一', weekday2: '周二', weekday3: '周三', weekday4: '周四', weekday5: '周五', weekday6: '周六',
      timezone: '时区', serverTime: '服务器时区', nextRuns: '接下来三次执行时间', invalid: '定时设置无效，请检查执行时间、日期或 Cron 表达式。',
    },
    conflictLabel: '冲突策略',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          selectTask: '选择任务 {id}',
          batchRetry: '批量重试',
          batchRetryConfirm: '将立即重新执行选中的 {count} 个失败任务，重试次数不会重置。确认继续？',
          batchRetrySuccess: '已重新执行 {count} 个失败任务',
          batchRetryPartial: '已重新执行 {success} 个任务，{failed} 个任务失败，请继续处理',

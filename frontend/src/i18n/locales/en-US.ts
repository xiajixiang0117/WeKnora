export default {
  sessionManagement: {
    "title": "Sessions",
    "description": "Review session sources, answer usage, and execution traces",
    "refresh": "Refresh",
    "searchLabel": "Search sessions",
    "searchPlaceholder": "Search by session title or ID",
    ...
    "responseDetails": "Answer details",
    "viewAnswer": "View answer",
    "finalAnswer": "Final answer",
    "executionTraces": "Execution traces",
    "loadingTraces": "Loading execution traces",
    "viewTrace": "View trace",
    "noTraces": "No execution traces",
    "traceDetail": "Trace details",
    "answerUnavailable": "Answer record unavailable",
    "citedChunks": "Cited chunks",
    "citedChunksNote": "Knowledge base chunks cited by this answer.",
    "truncated": "Content truncated",
    "noCitedChunks": "No cited chunks",
    "contextUnavailable": "This trace has no recorded model input context.",
    "generationContext": "Model input context",
    "rewrittenQuery": "Rewritten query",
    "expansionQueries": "Expanded queries",
    "recalledCount": "Retrieved count",
    "threshold": "Threshold",
    "generationContextNote": "Context chunks captured during answer generation",
    "allChannels": "All channels",
    "loadFailed": "Failed to load sessions. Please retry.",
    "loadDetailsFailed": "Failed to load session details. Please retry.",
    "loadTracesFailed": "Failed to load execution traces. Please retry.",
    "loadTraceFailed": "Failed to load trace details. Please retry.",
    "partialAnswer": "Answer is incomplete",
    "fallbackAnswer": "This answer uses a fallback response",
    "noAnswer": "No answer content",
    "noChunks": "No chunks",
    "selected": "Selected",
    "notSelected": "Not selected",
    "viewChunk": "View chunk",
    "documentCitationNote": "This citation matches a document; the exact chunk is unknown.",
    "referenceContentNote": "Content comes from answer references and may differ from the retrieved content.",
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          runNow: 'Run now',
          selectAll: 'Select all retryable tasks',
          selectTask: 'Select task {id}',
          batchRetry: 'Retry selected',
          batchRetryConfirm: 'Run the selected {count} failed tasks now without resetting their retry counts. Continue?',
          batchRetrySuccess: 'Retried {count} failed tasks',
          batchRetryPartial: 'Retried {success} tasks; {failed} failed. Please review the remaining tasks.',

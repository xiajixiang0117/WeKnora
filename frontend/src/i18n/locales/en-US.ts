export default {
  ...
  sessionManagement: {
    documentCitationNote: "This citation identifies a document URL. This chunk belongs to that source, but the exact cited chunk cannot be determined.",
    viewChunk: "Expand chunk content",
    noChunks: "No chunks recorded",
    notSelected: "Not selected",
    chunkUnavailable: "Chunk content was not saved; the original text cannot be restored.",
    referenceContentNote: "Recovered from the saved answer reference, which may include merged passages; this is not the original recall snapshot.",
    viewAnswer: "View answer",
    finalAnswer: "Final answer",
    partialAnswer: "This request did not complete. Any generated content is shown below.",
    fallbackAnswer: "This is a fallback answer.",
    noAnswer: "No answer content was generated.",
    answerUnavailable: "No answer snapshot or recoverable message is available.",
    citedChunks: "Chunks cited in the answer",
    citedChunksNote: "Only chunks explicitly cited by the answer are listed. Inclusion in model context does not imply citation.",
    noCitedChunks: "No explicit chunk citations were identified. Citations may be disabled or absent from the answer.",
    contextUnavailable: "Chunks supplied to the LLM were not recorded for this request and cannot be inferred from reranking.",
    generationContext: "Chunks supplied to the LLM",
    generationContextNote: "Chunks added to model context at this stage (captured / total)",

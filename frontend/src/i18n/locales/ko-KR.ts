export default {
  ...
  embedPublish: {
    ...
    originsHint: '한 줄에 하나의 임베드 호스트 출처(예: https://shop.example.com), 최소 1개; *.example.com 서브도메인 와일드카드 지원',
  ...
  sessionManagement: {
    documentCitationNote: "문서 URL 인용입니다. 이 청크는 같은 출처에 속하지만 정확히 어떤 청크가 인용되었는지는 확인할 수 없습니다.",
    viewChunk: "청크 내용 펼치기",
    noChunks: "기록된 청크 없음",
    notSelected: "선택되지 않음",
    chunkUnavailable: "청크 본문이 저장되지 않아 당시 내용을 복원할 수 없습니다.",
    referenceContentNote: "저장된 답변 참조에서 복원한 내용입니다. 병합된 구절이 포함될 수 있으며 원래 검색 당시의 본문은 아닙니다.",
    viewAnswer: "답변 보기",
    finalAnswer: "최종 답변",
    partialAnswer: "완료되지 않은 요청입니다. 생성된 내용을 표시합니다.",
    fallbackAnswer: "대체 답변입니다.",
    noAnswer: "생성된 답변 내용이 없습니다.",
    answerUnavailable: "저장된 답변이나 복원 가능한 메시지가 없습니다.",
    citedChunks: "답변에서 인용한 청크",
    citedChunksNote: "답변이 명시적으로 인용한 청크만 표시합니다. 모델에 전달되었다고 인용된 것은 아닙니다.",
    noCitedChunks: "명시적 청크 인용이 없습니다. 인용이 비활성화되었거나 답변에 인용이 없을 수 있습니다.",
    contextUnavailable: "LLM에 전달한 청크가 기록되지 않아 재순위 결과에서 추론할 수 없습니다.",
    generationContext: "LLM에 전달한 청크",
    generationContextNote: "이 단계에서 모델에 전달한 청크 (기록 / 전체)",

    title: '세션 관리',
    description: '이 워크스페이스의 각 세션에서 사용한 메인 채팅 모델 Token을 확인합니다. Embedding, 리랭킹, 제목 생성 등의 보조 호출은 제외됩니다.',
    refresh: '새로 고침', search: '검색', searchLabel: '세션 검색', channelFilter: '채널로 필터링', allChannels: '모든 채널', searchPlaceholder: '세션 제목 또는 ID로 검색', retry: '다시 시도',

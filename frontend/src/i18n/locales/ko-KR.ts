export default {
  sessionManagement: {
    "title": "세션 관리",
    "description": "세션 출처, 답변 사용량 및 실행 추적 확인",
    "refresh": "새로 고침",
    "searchLabel": "세션 검색",
    "searchPlaceholder": "세션 제목 또는 ID로 검색",
    "channelFilter": "채널 필터",
    "search": "검색",
    "retry": "다시 시도",
    "empty": "세션이 없습니다",
    "untitled": "제목 없는 세션",
    "unknownAgent": "사용할 수 없는 에이전트",
    "unrecordedAgent": "에이전트 기록 없음",
    "viewDetails": "상세 보기",
    "detailsTitle": "세션 상세",
    "loadingDetails": "상세 정보 로딩 중",
    "summary": "사용량 요약",
    "responseDetails": "답변 상세",
    "viewAnswer": "답변 보기",
    "finalAnswer": "최종 답변",
    "executionTraces": "실행 추적",
    "loadingTraces": "실행 추적 로딩 중",
    "viewTrace": "추적 보기",
    "noTraces": "실행 추적이 없습니다",
    "traceDetail": "추적 상세",
    "answerUnavailable": "답변 기록이 없습니다",
    "citedChunks": "인용 청크",
    "citedChunksNote": "이 답변에서 인용한 지식 베이스 청크입니다.",
    "truncated": "내용이 잘렸습니다",
    "noCitedChunks": "인용 청크가 없습니다",
    "contextUnavailable": "이 추적에는 모델 입력 컨텍스트가 기록되지 않았습니다.",
    "generationContext": "모델 입력 컨텍스트",
    "rewrittenQuery": "재작성 쿼리",
    "expansionQueries": "확장 쿼리",
    "recalledCount": "검색된 수",
    "threshold": "임계값",
    "generationContextNote": "답변 생성 시 기록된 컨텍스트 청크",
    "allChannels": "모든 채널",
    "loadFailed": "세션을 불러오지 못했습니다. 다시 시도하세요.",
    "loadDetailsFailed": "세션 상세를 불러오지 못했습니다. 다시 시도하세요.",
    "loadTracesFailed": "실행 추적을 불러오지 못했습니다. 다시 시도하세요.",
    "loadTraceFailed": "추적 상세를 불러오지 못했습니다. 다시 시도하세요.",
    "partialAnswer": "답변이 완료되지 않았습니다",
    "fallbackAnswer": "이 답변은 대체 응답을 사용합니다",
    "noAnswer": "답변 내용이 없습니다",
    "noChunks": "청크가 없습니다",
    "selected": "선택됨",
    "notSelected": "선택되지 않음",
    "viewChunk": "청크 보기",
    "documentCitationNote": "이 인용은 문서와 일치하지만 정확한 청크는 알 수 없습니다.",
    "referenceContentNote": "본문은 답변의 인용에서 가져왔으며 검색 당시 내용과 다를 수 있습니다.",
    "chunkUnavailable": "청크 본문이 없습니다",
    "columns": {
      "question": "질문",
      "session": "세션",
      "channel": "채널",
  ...
  datasource: {
    webCrawler: {
      scopeTitle: '웹사이트 크롤링 범위', seedUrls: '시작 URL', seedPlaceholder: 'https://docs.example.com/guide/index.html', seedHint: '한 줄에 하나씩 입력하세요. 같은 호스트와 경로 범위에서 페이지를 발견합니다.', seedRequired: '시작 URL을 하나 이상 입력하세요', allowedHosts: '허용 호스트', allowedHostsPlaceholder: '비워두면 시작 URL 호스트 사용', pathPrefixes: '경로 접두사', pathPrefixesPlaceholder: '/projects/sdk/latest', excludePatterns: '제외 패턴', excludePlaceholder: '정규식(쉼표로 구분)', contentSelector: '본문 CSS 선택자', contentSelectorPlaceholder: '예: #content 또는 article[role="main"]', contentSelectorHint: '선택자와 일치하는 HTML만 가져옵니다. 비워두면 본문을 자동으로 찾습니다.', excludeSelectors: '제외 CSS 선택자', excludeSelectorsPlaceholder: '예: .sidebar, .breadcrumbs', excludeSelectorsHint: '선택한 본문에서 일치하는 노드를 제거합니다. 여러 선택자는 쉼표로 구분하세요.', maxPages: '스캔당 최대 페이지', respectRobots: 'robots.txt 준수', batchHintTitle: '페이지는 배치로 처리됩니다', batchHint: '저장 후 “업데이트 확인”을 클릭하세요. 추가 및 변경 사항은 검토 후 50페이지 단위로 가져오며, 404/410으로 확인된 페이지의 연결된 지식은 자동으로 삭제됩니다.', reviewTitle: '웹사이트 업데이트 검토', manualSync: '수동 동기화', checkUpdates: '업데이트 확인', scanStarted: '업데이트 확인이 제출되었습니다', scanFailed: '업데이트 확인 실패', loadFailed: '스캔 결과를 불러오지 못했습니다', applyStarted: '일괄 적용이 제출되었습니다', applyFailed: '변경 사항 적용 실패', retryFailed: '실패 항목 재시도', selectAll: '모두 선택', clearSelection: '전체 선택 해제', applySelected: '선택 항목 적용 ({count})', keep: '유지', deleted: '삭제됨', applyConfirm: '선택한 변경 사항 {count}개를 적용하시겠습니까?', noChanges: '변경 사항이 없습니다', noScan: '스캔 기록이 없습니다', summary: '페이지 {total} · 추가 {added} · 변경 {updated} · 무효 {missing} · 실패 {failed}', change: { added: '추가', updated: '변경', missing: '무효', failed: '실패' }, status: { scanning: '스캔 중', review_ready: '검토 대기', applying: '적용 중', completed: '완료', partial_failed: '부분 실패', canceled: '취소됨' }
    },
    title: '데이터 소스 관리',
    ...
    scheduleEditor: {
      manual: '수동 동기화', minutes: '분 단위', hourly: '시간 단위', daily: '매일', weekly: '매주', monthly: '매월', advanced: '고급 Cron 표현식',
      interval: '간격', minuteUnit: '분', hourUnit: '시간', atTime: '실행 시간', atMinute: '실행할 분', monthDay: '실행일',
      weekday0: '일', weekday1: '월', weekday2: '화', weekday3: '수', weekday4: '목', weekday5: '금', weekday6: '토',
      timezone: '시간대', serverTime: '서버 시간대', nextRuns: '다음 3회 실행 시간', invalid: '시간, 날짜 또는 Cron 표현식을 확인하세요.',
    },
    conflictLabel: '충돌 전략',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          runNow: '지금 실행',
          selectAll: '재시도 가능한 작업 모두 선택',
          selectTask: '작업 {id} 선택',
          batchRetry: '선택한 작업 재시도',
          batchRetryConfirm: '선택한 실패 작업 {count}건을 재시도 횟수 초기화 없이 즉시 실행합니다. 계속할까요?',
          batchRetrySuccess: '실패 작업 {count}건을 다시 실행했습니다',
          batchRetryPartial: '{success}건을 다시 실행했고 {failed}건은 실패했습니다. 남은 작업을 확인하세요.',
  ...
  uploadConfirm: {
    webRulesTitle: '웹 본문 추출',
    webRulesDescription: '이번 URL 가져오기에만 적용됩니다. 비워 두면 자동 본문 인식을 사용합니다',
    webContentSelectorLabel: '본문 CSS 선택자',
    webContentSelectorPlaceholder: '예: article[role="main"]',
    webContentSelectorDescription: '일치하는 HTML 콘텐츠만 유지합니다',
    webExcludeSelectorsLabel: '제외할 CSS 선택자',
    webExcludeSelectorsPlaceholder: '예: aside, nav, header, footer',
    webExcludeSelectorsDescription: '선택한 본문에서 일치하는 노드를 제거합니다',

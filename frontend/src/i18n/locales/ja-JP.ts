export default {
  sessionManagement: {
    "title": "セッション管理",
    "description": "セッションの送信元、回答の使用量、実行トレースを確認",
    "refresh": "更新",
    "searchLabel": "セッションを検索",
    "searchPlaceholder": "セッション名または ID で検索",
    "channelFilter": "チャネルで絞り込み",
    "search": "検索",
    "retry": "再試行",
    "empty": "セッションはありません",
    "untitled": "無題のセッション",
    ...
    "summary": "使用量の概要",
    "responseDetails": "回答詳細",
    "viewAnswer": "回答を表示",
    "finalAnswer": "最終回答",
    "executionTraces": "実行トレース",
    "loadingTraces": "実行トレースを読み込み中",
    "viewTrace": "トレースを表示",
    "noTraces": "実行トレースはありません",
    "traceDetail": "トレース詳細",
    "answerUnavailable": "回答の記録がありません",
    "citedChunks": "引用チャンク",
    "citedChunksNote": "この回答が引用したナレッジベースのチャンクです。",
    "truncated": "内容は省略されています",
    "noCitedChunks": "引用チャンクはありません",
    "contextUnavailable": "このトレースにはモデル入力コンテキストが記録されていません。",
    "generationContext": "モデル入力コンテキスト",
    "rewrittenQuery": "書き換えたクエリ",
    "expansionQueries": "拡張クエリ",
    "recalledCount": "取得件数",
    "threshold": "しきい値",
    "generationContextNote": "回答生成時に記録されたコンテキストのチャンク",
    "allChannels": "すべてのチャネル",
    "loadFailed": "セッションを読み込めませんでした。再試行してください。",
    "loadDetailsFailed": "セッション詳細を読み込めませんでした。再試行してください。",
    "loadTracesFailed": "実行トレースを読み込めませんでした。再試行してください。",
    "loadTraceFailed": "トレース詳細を読み込めませんでした。再試行してください。",
    "partialAnswer": "回答は未完了です",
    "fallbackAnswer": "この回答はフォールバック応答です",
    "noAnswer": "回答内容はありません",
    "noChunks": "チャンクはありません",
    "selected": "選択済み",
    "notSelected": "未選択",
    "viewChunk": "チャンクを表示",
    "documentCitationNote": "この引用は文書に一致していますが、正確なチャンクは不明です。",
    "referenceContentNote": "本文は回答の引用に由来し、検索時の内容とは異なる場合があります。",
    "chunkUnavailable": "チャンク本文はありません",
    "columns": {
      "question": "質問",
      "session": "セッション",
      "channel": "チャネル",
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          runNow: '今すぐ実行',
          selectAll: '再試行可能なタスクをすべて選択',
          selectTask: 'タスク {id} を選択',
          batchRetry: '選択したタスクを再試行',
          batchRetryConfirm: '選択した失敗タスク{count}件を再試行回数をリセットせずに実行します。続行しますか？',
          batchRetrySuccess: '失敗タスク{count}件を再実行しました',
          batchRetryPartial: '{success}件を再実行しました。{failed}件は失敗しました。残りのタスクを確認してください。',

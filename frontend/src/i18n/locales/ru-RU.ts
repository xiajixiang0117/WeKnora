export default {
  sessionManagement: {
    ...
    "description": "Источники сессий, расход токенов и трассировки выполнения",
    "refresh": "Обновить",
    "searchLabel": "Поиск сессий",
    "searchPlaceholder": "Поиск по названию или ID сессии",
    "channelFilter": "Фильтр по каналу",
    "search": "Поиск",
    "retry": "Повторить",
    "empty": "Сессий пока нет",
    "untitled": "Сессия без названия",
    "unknownAgent": "Агент недоступен",
    "unrecordedAgent": "Агент не записан",
    "viewDetails": "Подробнее",
    "detailsTitle": "Сведения о сессии",
    "loadingDetails": "Загрузка сведений",
    "summary": "Сводка использования",
    "responseDetails": "Сведения об ответах",
    "viewAnswer": "Просмотр ответа",
    "finalAnswer": "Итоговый ответ",
    "executionTraces": "Трассировки выполнения",
    "loadingTraces": "Загрузка трассировок",
    "viewTrace": "Просмотр трассировки",
    "noTraces": "Трассировок нет",
    "traceDetail": "Сведения о трассировке",
    "answerUnavailable": "Запись ответа недоступна",
    "citedChunks": "Цитируемые фрагменты",
    "citedChunksNote": "Фрагменты базы знаний, на которые ссылается ответ.",
    "truncated": "Содержимое сокращено",
    "noCitedChunks": "Нет цитируемых фрагментов",
    "contextUnavailable": "В этой трассировке не записан входной контекст модели.",
    "generationContext": "Входной контекст модели",
    "rewrittenQuery": "Переформулированный запрос",
    "expansionQueries": "Расширенные запросы",
    "recalledCount": "Число найденных",
    "threshold": "Порог",
    "generationContextNote": "Фрагменты контекста, записанные при формировании ответа",
    "allChannels": "Все каналы",
    "loadFailed": "Не удалось загрузить сессии. Повторите попытку.",
    "loadDetailsFailed": "Не удалось загрузить сведения о сессии. Повторите попытку.",
    "loadTracesFailed": "Не удалось загрузить трассировки. Повторите попытку.",
    "loadTraceFailed": "Не удалось загрузить сведения о трассировке. Повторите попытку.",
    "partialAnswer": "Ответ не завершён",
    "fallbackAnswer": "Использован резервный ответ",
    "noAnswer": "Нет содержимого ответа",
    "noChunks": "Нет фрагментов",
    "selected": "Выбран",
    "notSelected": "Не выбран",
    "viewChunk": "Просмотр фрагмента",
    "documentCitationNote": "Ссылка соответствует документу, но точный фрагмент неизвестен.",
    "referenceContentNote": "Текст взят из ссылок ответа и может отличаться от найденного содержимого.",
    "chunkUnavailable": "Текст фрагмента недоступен",
    "columns": {
      "question": "Вопрос",
      "session": "Сессия",
      "channel": "Канал",
  ...
  datasource: {
    ...
    scheduleEditor: {
      manual: 'Вручную', minutes: 'По минутам', hourly: 'По часам', daily: 'Ежедневно', weekly: 'Еженедельно', monthly: 'Ежемесячно', advanced: 'Выражение Cron',
      interval: 'Интервал', minuteUnit: 'мин.', hourUnit: 'ч.', atTime: 'Время запуска', atMinute: 'Минута запуска', monthDay: 'День месяца',
      weekday0: 'Вс', weekday1: 'Пн', weekday2: 'Вт', weekday3: 'Ср', weekday4: 'Чт', weekday5: 'Пт', weekday6: 'Сб',
      timezone: 'Часовой пояс', serverTime: 'Часовой пояс сервера', nextRuns: 'Следующие три запуска', invalid: 'Проверьте время, дату или выражение Cron.',
    },
    ...
    field: {
      ...
      fileUrls: 'Адреса файлов',
      fileUrlsHint: 'По одному адресу PDF или другого файла в строке; измененные файлы анализируются повторно по расписанию.',
    ...
    connectorDesc: {
      ...
      remote_file: 'Синхронизация PDF и других файлов по URL',
    ...
    globalSettings: {
      ...
      runtime: {
        ...
        tasks: {
          ...
          selectAll: 'Выбрать все задачи, доступные для повтора',
          selectTask: 'Выбрать задачу {id}',
          batchRetry: 'Повторить выбранные',
          batchRetryConfirm: 'Сейчас повторно запустить {count} выбранных сбойных задач без сброса счётчика повторов?',
          batchRetrySuccess: 'Повторно запущено сбойных задач: {count}',
          batchRetryPartial: 'Повторно запущено: {success}; не удалось: {failed}. Проверьте оставшиеся задачи.',

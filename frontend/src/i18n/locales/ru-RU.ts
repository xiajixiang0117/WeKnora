export default {
  ...
  embedPublish: {
    ...
    originsHint: 'Один origin хоста, которому разрешено встраивание (напр. https://shop.example.com), минимум один; поддерживаются поддомены *.example.com',
  ...
  sessionManagement: {
    documentCitationNote: "Ссылка указывает на URL документа. Фрагмент относится к этому источнику, но точный процитированный фрагмент неизвестен.",
    viewChunk: "Показать текст фрагмента",
    noChunks: "Фрагменты не записаны",
    notSelected: "Не выбран",
    chunkUnavailable: "Текст фрагмента не сохранён. Исходный текст восстановить невозможно.",
    referenceContentNote: "Восстановлено из сохранённой ссылки ответа. Текст может объединять несколько фрагментов и не является исходным снимком поиска.",
    viewAnswer: "Показать ответ",
    finalAnswer: "Итоговый ответ",
    partialAnswer: "Запрос не завершён. Ниже показан сгенерированный текст.",
    fallbackAnswer: "Это резервный ответ.",
    noAnswer: "Текст ответа не сгенерирован.",
    answerUnavailable: "Нет снимка ответа или сообщения для восстановления.",
    citedChunks: "Фрагменты, процитированные в ответе",
    citedChunksNote: "Показаны только явно процитированные фрагменты. Передача в контекст модели не означает цитирование.",
    noCitedChunks: "Явные ссылки на фрагменты не найдены. Цитирование может быть отключено или отсутствовать в ответе.",
    contextUnavailable: "Фрагменты, переданные LLM, не записаны. Их нельзя определить по результатам ранжирования.",
    generationContext: "Фрагменты, переданные LLM",
    generationContextNote: "Фрагменты в контексте модели на этом этапе (записано / всего)",
